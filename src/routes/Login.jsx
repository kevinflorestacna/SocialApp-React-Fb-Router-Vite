        ...
        <section className="flex flex-row md:flex-row h-screen items-center">
            ...
            <div className="bg-white items-center justify-center flex md:mx-auto md:max-w-md lg:max-w-full w-full md:w-1/2 xl:w-1/3 px-6 lg:px-16 xl:px-12">
                <div className="w-full h-full">
                    ...
                    <h1 className="text-xl font-bold leading-tight mb-6">Ingresar una Cuenta</h1>
                    <form onSubmit={handleSubmit(onSubmit)} className="mt-6">
                        ...
                        <div className="text-right mt-2">
                            <a href="#" className="text-sm font-semibold text-gray-700 hover:text-blue-700 focus:text-blue-700 focus:outline-none">Olvidaste tu contraseña</a>
                        </div>
                        <button type="submit" className="w-full block bg-blue-500 hover:bg-blue-400 px-4 py-3 mt-6 runded-lg font-semibold text-white focus:bg-blue-400 focus:outline-none">Acceder</button>
                        ...
                        <p className="flex justify-between py-3">
                            No tienes cuenta?
                            <NavLink to="/register"><span className="text-blue-500 hover:text-rose-500">Registrate aqui</span></NavLink>
                        </p>
